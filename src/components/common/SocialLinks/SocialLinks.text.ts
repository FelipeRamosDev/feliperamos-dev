...
socialLinksText.create('SocialLinks.github', 'Perfil GitHub', 'pt-BR');

socialLinksText.create('SocialLinks.email', 'Email Felipe');
socialLinksText.create('SocialLinks.email', 'Enviar Email para o Felipe', 'pt-BR');

socialLinksText.create('SocialLinks.linkedin', 'LinkedIn Profile');
socialLinksText.create('SocialLinks.linkedin', 'Perfil LinkedIn', 'pt-BR');

socialLinksText.create('SocialLinks.whatsapp', 'WhatsApp Felipe');
socialLinksText.create('SocialLinks.whatsapp', 'Enviar WhatsApp para o Felipe', 'pt-BR');

socialLinksText.create('SocialLinks.phone', 'Call to Felipe');
socialLinksText.create('SocialLinks.phone', 'Ligar para o Felipe', 'pt-BR');
