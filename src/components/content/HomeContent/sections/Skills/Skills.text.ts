...
skillsText.create('Skills.title', 'Principais Habilidades', 'pt');
...
skillsText.create('Skills.description', 'Confira abaixo minhas habilidades e tecnologias que tenho experiência: Linguagens de programação, Frameworks, Bibliotecas, Ferramentas e muito mais.', 'pt');
